...
namespace std
{
    ...
    template<> struct less<ThreePtKeys::KeyHadronSUNNPartNPtIrrep_t>
    {
       bool operator() (const ThreePtKeys::KeyHadronSUNNPartNPtIrrep_t& lhs, const ThreePtKeys::KeyHadronSUNNPartNPtIrrep_t& rhs) const
       {
