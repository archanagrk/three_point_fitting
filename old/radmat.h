...
namespace radmat
{
  ...
  struct RadmatExtendedKeyHadronNPartIrrep_t
  {
    ...
    RadmatExtendedKeyHadronNPartIrrep_t(const std::string particle_id, const Hadron::KeyHadronSUNNPartIrrep_t basic_key)
    ...
    {
      m_basic_key.irrep_mom.mom[0] = 0;
      m_basic_key.irrep_mom.mom[1] = 0;
      m_basic_key.irrep_mom.mom[2] = 0;
      m_basic_key.irrep_mom.row = 0; 
    }

    std::string m_particle_id;    
    Hadron::KeyHadronSUNNPartIrrep_t m_basic_key;
  };
